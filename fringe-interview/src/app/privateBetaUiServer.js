...
export function createPrivateBetaUiRequestHandler({locale="it",journeyOptions={},journeyEntryPoint=null,stagedPrepare=prepareStagedPrivateBetaJourney,stagedAnswer=answerStagedPrivateBetaJourney,stagedFinalize=finalizeStagedPrivateBetaJourney,sessionStore=new Map(),recentQuestionStore=new Map(),contextIdFactory=()=>randomUUID()}={}){
