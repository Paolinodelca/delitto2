...
.nav-link.premium.active {
  ...
  box-shadow:
    0 14px 24px rgba(15, 23, 42, 0.16),
    0 0 0 3px rgba(147,51,234,0.18),
    inset 0 1px 0 rgba(255,255,255,0.85);
}
...
.nav-side-tag.free { background: #16a34a; }
.nav-side-tag.pro { background: #7c3aed; }
.nav-side-tag.premium { background: #9333ea; }
