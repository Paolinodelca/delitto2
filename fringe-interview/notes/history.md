...
🔁 SHIFT CONCETTUALE — INTERVIEW ENGINE

Il progetto FRINGE Interview evolve da:

question selection engine
→ a

interview investigation engine

Nuovo principio guida

Il colloquio non è una sequenza di domande, ma una progressione narrativa che:

fa emergere il racconto del candidato

lo confronta con una traiettoria attesa

individua scostamenti

attiva affondi mirati

verifica coerenza, maturità e responsabilità

Implicazioni

ridurre domande multiple o accorpate
...
eliminare meta-spiegazioni nella voce dell’intervistatore

spostare logica valutativa nel trainer mode

Nuovi concetti introdotti

Interview Spine

Expected Career Logic
...
Il sistema FRINGE Interview ha superato la fase puramente tecnica ed è entrato nella fase di definizione del **modello valutativo reale**, basato su logiche di colloquio professionale.

Non si tratta più di generare domande, ma di simulare un processo decisionale di selezione.

---

## 🧠 Modello concettuale attuale

### 1. Il sistema NON valuta il candidato in assoluto

👉 Valuta:

> **coerenza tra storia del candidato e ruolo target (JD)**

---

## 🔒 BLOCCO 1 — TECHNICAL GATING

Le competenze tecniche NON sono un asse continuo, ma un filtro.

### Stati possibili:

* ❌ KO → manca competenza base non sostituibile
* ⚠️ BORDERLINE → gap recuperabile (tool simili, apprendimento possibile)
* ✅ OK → competenze presenti o trasferibili
...
* contesto urgente → gap = KO
* contesto strutturato → gap = accettabile

---

## 🎯 BLOCCO 2 — CORE EVALUATION (3 assi)

### 🥇 1. Decisione in ambiguità

* prende posizione?
* esplicita trade-off?
* accetta di sacrificare qualcosa?
* gestisce conseguenze?

---

### 🥈 2. Capacità di sintesi

* comprime informazione?
* arriva al punto?
* è orientato all’azione?

---

### 🥉 3. Gestione attriti / conflitto

* evita conflitto → debole
* impone → rischio
* sostiene posizione mantenendo relazione → target
...
* tipo azienda:
  ...
  * PMI → autonomia e decisione
  * corporate → allineamento e processo

* pressione operativa:

  * alta → serve immediatezza
  * bassa → spazio per crescita

---

## ⚙️ INTERVIEW LOGIC (nuovo paradigma)

Il colloquio non è più sequenza di domande isolate.

👉 È una **progressione narrativa con pressione crescente**
...
2. Contesto ruolo
3. Caso concreto
4. Responsabilità reale
5. Decisione (trade-off)
6. Pressione / attrito
7. Verifica profondità (secondo caso)
8. Closing
...
Il sistema aumenta progressivamente:
...
4. Trade-off
5. Conflitto
6. Secondo esempio (anti-improvvisazione)
...
* nessun attrito mai
* racconto troppo pulito
* uso del plurale
* mancanza di decisioni
* timeline incoerente
* cambi senza crescita
* mancanza di pressione reale
...
### C. Raccomandazione (stile recruiter)

* rischio inserimento
* contesto ideale
* compatibilità con ruolo

---

## 🧩 DUAL MODE

### 👤 Coach Mode (utente finale)

* A + B + (C semplificato)

### 🧑‍💼 Recruiter Mode (futuro)
...
* NON è un quiz
* NON è un simulatore di domande

👉 È:

> **un motore di valutazione comportamentale sotto pressione**

---

## 📌 Stato

✅ Modello concettuale definito
🔄 Da implementare nel motore runtime e nella UI
🎯 Pronto per nuova fase di sviluppo guidata
