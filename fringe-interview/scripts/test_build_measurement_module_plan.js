...
console.log(JSON.stringify({
  test: "Measurement Module Plan Integrated",
...
if (failures.length > 0) {
  console.error("Measurement Module Plan Integrated Test: FAIL");
  console.error(JSON.stringify(failures, null, 2));
  process.exit(1);
}

console.log("Measurement Module Plan Integrated Test: PASS");
